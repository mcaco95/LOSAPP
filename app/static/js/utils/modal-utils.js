...
(function(window) {
    ...
    const ModalUtils = {
         ...
         * @param {Object} options - Optional modal configuration
         */
        showModal: function(content, options = {}) {
            ...
            modalElement.id = options.id || 'dynamicModal';
            modalElement.setAttribute('tabindex', '-1');
            modalElement.setAttribute('aria-hidden', 'true');
            
            // Set modal size if specified
            const dialogClass = options.size ? `modal-${options.size}` : '';
        ...
        /**
         * Update the content of the current modal
